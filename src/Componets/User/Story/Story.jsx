...
export default function Story() {
  ...
  <Avatar className="mt-1 flex-none w-[65px] h-[65px] md:w-[80px] md:h-[80px]"isBordered color="secondary" src="https://i.pravatar.cc/150?u=a042581f4e29026704d"/>
  <Avatar className="mt-1 flex-none w-[65px] h-[65px] md:w-[80px] md:h-[80px]" isBordered color="primary" src="https://i.pravatar.cc/150?u=a04258a2462d826712d" />
  <Avatar className="mt-1 flex-none w-[65px] h-[65px] md:w-[80px] md:h-[80px]" isBordered color="success" src="https://i.pravatar.cc/150?u=a04258114e29026302d" />
  <Avatar className="mt-1 flex-none w-[65px] h-[65px] md:w-[80px] md:h-[80px]"  isBordered color="warning" src="https://i.pravatar.cc/150?u=a04258114e29026702d" />
